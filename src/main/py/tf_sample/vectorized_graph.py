...
with graph.as_default():
    ...
    with tf.name_scope("summaries"):
        tf.summary.scalar(b'output', output, family="output_summary")  # Creates summary for output node
        tf.summary.scalar(b'product_of_inputs', b, family="prod_summary")
        tf.summary.scalar(b'sum_of_inputs', c, family="sum_summary")
...
writer = tf.summary.FileWriter('log/improved_graph', graph)
